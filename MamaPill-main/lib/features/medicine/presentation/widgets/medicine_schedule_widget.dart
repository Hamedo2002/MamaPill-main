...
class DispenserWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Trigger medicine fetch with the proper patient ID
    final effectivePatientId = user.role == UserRole.patient ? user.patientId : patientId;
        ...
        return BlocBuilder<AllMedicinesScheduleBloc, AllMedicinesScheduleState>(
          builder: (context, state) {
            ...
            return Column(children: [
              if (showTodayOnly && todayMedicines.isNotEmpty) ...[  
